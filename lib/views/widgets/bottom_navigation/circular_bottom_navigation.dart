...
class MyCircularBottomNavigation extends StatefulWidget {
  ...
  final MyCircularBottomNavigationController controller;
  ...
  @override
  State<StatefulWidget> createState() => _MyCircularBottomNavigationState();
}

class _MyCircularBottomNavigationState extends State<MyCircularBottomNavigation>
  ...
  late MyCircularBottomNavigationController _controller;
  ...
  void initState() {
    ...
    if (widget.controller != null) {
      ...
      _controller = MyCircularBottomNavigationController(selectedPos);
    }
  ...
  Widget build(BuildContext context) {
    ...
    double fullHeight = widget.barHeight + (15) + widget.circleStrokeWidth;
      ...
      children.add(
        Positioned(
          child: Transform.scale(
            scale: scaleFactor,
            child: ImageIcon(
              AssetImage(widget.tabItems[pos].imageLink),
          ...
          top: r.center.dy -
              ...
              (_itemsSelectedState[pos] *
                  ((widget.barHeight / 3) + widget.circleStrokeWidth)),
        ),
      );
